...
SnailBait.prototype = {
    ...
    equipRunnerForFalling: function () {
        ...
        this.runner.stopFalling = function () {
            console.log('=== stopFalling() called ===');
            console.log('Runner vertical velocity:', this.velocityY, 'pixels/second');
            console.log('Was falling:', this.falling);
            console.log('Runner position - top:', this.top, 'left:', this.left);
            this.falling = false;
            this.velocityY = 0;
