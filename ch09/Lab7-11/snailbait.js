var SnailBait = function () {
    ...
    this.COLLISION_MARGINS = {
        runner: {
            top: 10,      // Shrink hitbox from top
            bottom: 10,   // Shrink hitbox from bottom
            left: 10,     // Shrink hitbox from left
            right: 10     // Shrink hitbox from right
        },
        coin: {
            top: 5,
            bottom: 5,
    ...
    this.collideBehavior = {
        ...
        didRunnerCollideWithOtherSprite: function (r, o, context) {
            // Determine if any of the runner's four corners or center
            // lies within the other sprite's bounding box
...
SnailBait.prototype = {
    ...
    checkForCollisions: function () {
        ...
        // Helper: bounding-box collision test accounting for sprite offsets
        function boundingBoxCollides(runner, sprite) {
            // Calculate sprite's actual screen position (accounting for hOffset)
        ...
        // ---- Collectibles (coins, rubies, sapphires) ----
        ...
        for (var i = 0; i < collectibles.length; ++i) {
            ...
            if (sprite.visible && this.isSpriteInView(sprite) && boundingBoxCollides(runner, sprite)) {
                sprite.visible = false; // Hide after collection
                this.score += sprite.value || 50;

                // Update ONLY the HTML score element
        ...
        // ---- Enemies (snails, bats, bees, and bombs) ----
    ...
    drawCollisionBoxes: function () {
        ...
        // Red boxes for hitboxes
        this.context.strokeStyle = 'rgba(255, 0, 0, 0.8)';
        this.context.lineWidth = 2;

        // Draw runner's collision box
        ...
        // Draw collision boxes for all other sprites
        for (var i = 0; i < this.sprites.length; ++i) {
            ...
            if (sprite.visible && this.isSpriteInView(sprite) && sprite !== this.runner) {
                ...
                // Account for sprite offset (scrolling)
                var spriteScreenLeft = sprite.left - (sprite.hOffset || 0);
